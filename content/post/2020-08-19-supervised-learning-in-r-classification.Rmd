...
![](/data_fintech_solutions/public/img/banners/temp.png)
...
The `where9am` data frame contains 91 days (thirteen weeks) woth of data in which Brett recorded his location at 9am each day as well whether the daytyoe was a weekend or weekday.
