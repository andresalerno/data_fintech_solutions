...
## 4. Printing HTTP request results in Python using urllib
...
## 7. Turning a webpage into data using BeautifulSoup: getting the text
...
## 8. Turning a webpage into data using BeautifulSoup: getting the hyperlinks
...
## 9. Loading and exploring a JSON
...
## 11. JSON–from the web to Python
...
## 12. Checking out the Wikipedia API
...
## 15. Load and explore your Twitter data
...
## 17. A little bit of Twitter text analysis
